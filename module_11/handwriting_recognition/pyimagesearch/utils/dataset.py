...
def load_digits(datasetPath):
    # build the dataset and the split it into data and labels
...
def deskew(image, width):
    # grab the wirdth and height of an image and compute moments for the image
    (h, w) = image.shape[:2]
